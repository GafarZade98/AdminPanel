...
@section('content')
                ...
                <div class="">
                    <div class="col-sm-6 product-left">
                        <div class="product-info">
                            <div class="left product-image thumbnails">    <!-- Megnor Cloud-Zoom Image Effect Start -->
                                <div class="image"><a class="thumbnail" title="nulla pariatur deserunt"><img id="tmzoom"
                                                                                                             src="image/cache/catalog/pro/5-644x634.jpg"
                                                                                                             data-zoom-image="http://themetechmount.net/opencart/autovio-layout2/image/cache/catalog/pro/5-800x788.jpg"
                                                                                                             title="nulla pariatur deserunt"
                                                                                                             alt="nulla pariatur deserunt"/></a>
                                </div>
                    ...
                    <div class="col-sm-5 product-right">
                        <h3 class="product-title">nulla pariatur deserunt</h3>
                        <div class="rating-wrapper"><span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i
                        ...
                        <ul class="list-unstyled short-desc">
                            <li><span class="desc">Brand:</span><a
                                    href="index98fa.html?route=product/manufacturer/info&amp;manufacturer_id=8">adipiscing </a>
                            </li>
                            <li><span class="desc">Product Code:</span>Product 17</li>
                            <li><span class="desc">Reward Points:</span>700</li>
                            <li><span class="desc">Availability:</span>In Stock</li>
                        </ul>
                        <ul class="list-unstyled price">
                            <li>
                                <h2 class="product-price">$1,262.00</h2>
                            </li>
                            <li class="price-tax">Ex Tax:<span>$1,050.00</span></li>
                        </ul>
                        <div id="product2">
                            ...
                            <div class="product-rightinfo">
                                ...
                                <div class="form-group cart-block">
                                    ...
                                    <button type="button" id="button-cart2" data-loading-text="Loading..."
                                            class="btn btn-primary btn-lg btn-block">Add to Cart
                                    </button>
                                </div>
                                <div class="btn-group wish-comp">
                                    <button type="button" class="btn btn-default wishlist" title="Add to Wish List"
                                            onclick="parent.wishlist.add('44');"><i class="fa fa-heart"></i>Add to Wish
                                        List
                                    </button>
                                    <button type="button" class="btn btn-default compare" title="Compare this Product"
                                            onclick="parent.compare.add('44');"><i class="fa fa-area-chart"></i>Compare
                                        this Product
                                    </button>
                                </div>
    ...
    <div id="tabs_info" class="product-tab col-sm-12 ">
        ...
        <div class="tab-content">
            <div class="tab-content-inner active" id="tab-description"><p>
                    <font face="helvetica,geneva,arial" size="2"><font face="Helvetica" size="2">The
                            ...
                            achieve. <br>
                            <br>
                        </font><font face="Helvetica" size="2">The Cinema HD features an active-matrix
                            ...
                            <br>
                        </font><font face="Helvetica" size="2">Offering accurate, brilliant color
                            ...
                            <br>
                        </font><font face="Helvetica" size="2">Housed in a new aluminum design, the
                            ...
                            <br>
                        </font><font face="Helvetica" size="2">The Cinema HD features a single cable
                ...
                <ul>
                    <li>
                        ...
                        image quality and vivid, richly saturated color.
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        bandwidth and VESA DDC standard for plug-and-play setup
                    </li>
                </ul>
            </div>
            <div class="tab-content-inner" id="tab-specification">
