                                    ...
                                    <div class="product-block product-thumb">
                                        <div class="product-thumb-inner">
                                            <div class="image"><a
                                                ...
                                                <div class="saleback">
                                                    <span class="saleicon sale">Endirim</span>
                                                </div>

                                            </div>
                                            <div class="caption">
                                                <div class="category">{{$product->getAttribute('name')}}</div>
                                                <h4>
                                                <a href="index6320.html?route=product/product&amp;product_id=28">{{$product->getAttribute('description')}}</a></h4>
                                                <p class="price"><span class="price-new">{{$product->getAttribute('price')}} AZN</span> <span
                                                        class="price-old">{{$product->getAttribute('price') * 1.10}} AZN</span> <span
                                                        class="price-tax">{{$product->getAttribute('tax')}} AZN</span> <span
                                                        class="percentsaving">10% </span></p>
...
{{--                                            <img--}}
{{--                                                src="{{asset('assets/img/frontend/image/cache/catalog/pro/12-254x252.jpg')}}"--}}
...
{{--                                            <img--}}
{{--                                                src="{{asset('assets/img/frontend/image/cache/catalog/pro/15-254x252.jpg')}}"--}}
...
{{--                                                class="price-tax">Ex Tax:$30.00</span>--}}
...
{{--                                            <img--}}
{{--                                                src="{{asset('assets/img/frontend/image/cache/catalog/pro/13-254x252.jpg')}}"--}}
{{--                                                title="adipiscing mollitelit ipsum"--}}
{{--                                                alt="adipiscing mollitelit ipsum"--}}
{{--                                                class="img-responsive reg-image"/>--}}
{{--                                            <img class="img-responsive hover-image"--}}
